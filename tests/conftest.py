...
def sample_flight_raw_data():
    ...
    return {
        "time": 1609459200,
        "states": [
            ["abc123", "UAL123 ", "United States", 1609459100, 1609459200, -122.4, 37.8, 10000.0, False, 250.0, 90.0, 5.0, None, 10500.0, "1234", False, 0],
            ["def456", "BAW456 ", "United Kingdom", 1609459100, 1609459200, -0.1, 51.5, 11000.0, False, 280.0, 180.0, -2.0, None, 11500.0, "5678", False, 0],
            ["ghi789", "DLH789 ", "Germany", 1609459100, 1609459200, 8.5, 50.0, 9500.0, True, 0.0, 0.0, 0.0, None, 9800.0, "9012", False, 0],
            ["jkl012", "AFR012 ", "France", 1609459100, 1609459200, 2.3, 48.9, 12000.0, False, 300.0, 270.0, 3.0, None, 12500.0, "3456", False, 0],
            ["mno345", "UAL999 ", "United States", 1609459100, 1609459200, -73.9, 40.7, 8000.0, False, 220.0, 45.0, 10.0, None, 8500.0, "7890", False, 0],
        ]
    }
...
def sample_flight_silver_df():
    ...
    return pd.DataFrame({
        ...
        "origin_country": ["United States", "United Kingdom", "Germany", "France", "United States"],
